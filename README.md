...
Magical fairy-style interactions
...
To design an attractive interface for users to explore cake designs

To allow users to view cakes by category

To provide a simple and interactive cake ordering experience

To demonstrate the use of modern web technologies

To create a realistic bakery website rather than a simple student project
...
**Home Page** – Introduces the bakery and displays featured cakes

**Cake Menu Page** – Shows cake varieties with filtering options

**Order Page** – Allows users to submit cake orders
...
- Aesthetic pastel themed user interface


**JavaScript Features**

To enhance interactivity, the website includes several JavaScript-based features:
...
Teenagers and young adults who love aesthetic cakes

People planning birthdays or weddings

Cake lovers and dessert enthusiasts

Event planners looking for cake inspiration
...
Browse featured cakes and bakery information

Go to the Menu Page to explore cake varieties

Use the filter buttons to view cakes by category

Click a cake to see more details

Visit the Order Page

Fill in the order form with your details

Submit the order to see the magical confirmation animation
